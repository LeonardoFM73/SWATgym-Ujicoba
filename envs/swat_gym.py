...
class SWATEnv(gym.Env):
    ...
    def __init__(self, max_action=60.0, seed=None, latitude = -6.920217043892493, longitude = 107.77264624120102, elevation = 206):
        # gym params
        ...
        self.start_date = datetime.datetime(2022, 9, 1)
        self.end_date = datetime.datetime(2022, 11, 29)
